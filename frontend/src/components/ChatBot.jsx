...
export default function ChatBot({ isOpen, onClose }) {
  ...
  const sendMessage = async (text) => {
    ...
    try {
      ...
      setMessages(prev => [...prev, { role: 'assistant', content: 'Sorry, I could not reach the server. Make sure the backend is running on port 8000.' }])
    } finally {
      setTyping(false)
    }
  }
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 w-96 max-w-[calc(100vw-2rem)]">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 flex flex-col" style={{ height: '560px' }}>
